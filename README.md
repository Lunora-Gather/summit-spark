...
P173 将部署资源统一到 `public/`，删除重复 HTML、空 `src/`、一次性迁移补丁、未接入运行时的兼容脚手架和写权限自动 PR 工作流；文档和工具收敛到实际产品边界，并保留 P172 的 CSP、Appwrite、服务器与 CI 供应链加固。
