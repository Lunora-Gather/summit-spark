...
P174 将主菜单收成一个主动作和三个次级入口，把练习面板从四个并列系统收成“选择房间 / 训练记录”两层结构；R4–R10 增加折返、上下路线、恢复平台、风道边界和终盘连续段，并保持原有机制教学顺序。P173 的 `public/` 发布边界和 P172 的安全加固继续保留。
