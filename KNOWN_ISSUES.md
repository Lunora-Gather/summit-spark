...
- The R7→R8 pressure curve is intentionally demanding; p281–p283 add a longer mechanic read-in, explicit first-focus copy, spawn self-healing and runtime finite-state recovery, but a full uninterrupted human route is still required before tuning authored geometry or targets. Do not treat a single death as evidence that the curve is unfair.
