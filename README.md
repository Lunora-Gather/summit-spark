...
P176 把已有的四套色彩、地标和机制真正编排成章节：跨入旧峰、风峡与星顶时会有不计时的短暂呼吸和本幕动作主题；四幕分别使用灯火微尘、旧峰尘屑、风线与上升星芒，让章节变化在游玩画面中可感知，而不增加菜单或常驻提示。P175 的微光尾带、环境和声和严格隔离记录的舒缓辅助继续保留。
