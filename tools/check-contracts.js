...
if (!css.includes("P117: quiet right-side tools and a cohesive mist-sheet panel") || !css.includes(".hud-actions {\n  gap: 7px;") || !css.includes("border-color: transparent;\n  background: none;\n  box-shadow: none;") || !css.includes("width: min(520px, calc(100% - 36px));") || !css.includes("rgba(224, 233, 226, 0.985)") || !css.includes("-webkit-line-clamp: 2;")) errors.push("practice/settings should retain the compact mist-sheet palette, unboxed HUD tools and readable two-line launch summary");
