...
export const ROOM_GUIDES = [
    ...
    "先从中棱折回左侧光继；后段先读相位节拍，再决定稳过或上探微光。",
    "用六枚光继分段校准三级弹簧，破门后借相位台收住长房出口。",
    "踩上脆冰就离开，借风升高；后半程先取微光，再沿虚线判断晶核轨迹。",
    "干净进入棱镜；长房后段把破门、晶核与相位台拆成三次判断。",
    "先点亮回声并借风落稳中层；后半程越过长脆冰，再等晶核让出路线。",
    "立回声后用弹簧完成开场；营灯处重整，再把破门、相位、晶核与末段脆冰连到终点。"
  ];
...
export const ROOM_PURPOSES = [
    ...
    "用错位双弹簧完成山门终考",
    "读清危险线并串联光继，最后用冲刺破门",
    "用中棱折返，再在后段相位节拍中选择稳过或取微光",
    "用六枚光继、三级弹簧、破门与相位台完成旧峰终考",
    "脆冰上果断离开，并在后半程微光支线与晶核轨迹间作选择",
    "用棱镜穿越脆冰，再组合破门、相位与晶核完成风峡终考",
    "掌握回声锚点，在稳定中层与后段长脆冰之间控制风险",
    "用回声保底，让弹簧开场、营灯重整与末段综合机关形成终章三拍"
  ];
...
export const ROOM_ROUTE_LINES = [
    ...
    ["安全线：中棱折返，等相位台亮起再落", "进阶线：光继后踩准两组相位台并保持高度", "高手线：Wall Spark 直切，跳过等待并上探微光"],
    ...
    ["安全线：点亮回声，落稳中层再分段越过长冰", "进阶线：风接棱镜，踩相位台穿过晶核空档", "高手线：下探微光，召回后贴长冰与晶核轨迹重接"],
    ["安全线：回声开场，营灯后再拆解末段机关", "进阶线：破门接相位台，再借风穿晶核与脆冰", "高手线：早段带回微光，把三拍路线无停顿连到星顶"]
  ];
