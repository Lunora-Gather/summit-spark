...
export const ROOM_SKILLS = [
    ...
    ["finale", "echo", "spring", "wind", "overdrive"]
  ];
...
export const ROOM_GUIDES = [
    ...
    "先读两级弹簧的错位落点，过顶后再花冲刺。",
    "先读安全平台线，再把光继点连起来。",
    "先从中棱折回左侧光继，保留冲刺再回到上层；高手可沿中棱 Wall Spark 直切。",
    "用四枚光继分段校准两级弹簧，把旧峰的组合句收完整。",
    "踩上脆冰就离开，让风把高度补回来。",
    "干净进入棱镜，穿过脆冰后借最后一股风收住。",
    "先点亮本章第一枚回声锚点，借风落稳中层，再把棱镜接上。",
    "先在起步台建立回声保底，用弹簧接回第一幕的光继节拍，再把风与棱镜带到高位终点。"
  ];
...
export const ROOM_PURPOSES = [
    ...
    "用错位双弹簧完成山门终考",
    "读清危险线后串联光继点",
    "用中棱完成一次明确折返，并保留 Wall Spark 直切线",
    "用四枚光继和两级弹簧完成旧峰终考",
    "脆冰上果断离开，借风回高度",
    "用棱镜穿越脆冰，再借风完成风峡终考",
    "正式掌握回声锚点，在风与棱镜之间建立一次稳定回收",
    "用回声保底，以弹簧接光继重现山门节拍，再组合风、棱镜与脆冰完成高位收束"
  ];
...
export const ROOM_ROUTE_LINES = [
    ...
    ["安全线：在中棱折回左侧光继，再从安全台回升", "进阶线：光继后不落地，沿中棱回到上层", "高手线：Wall Spark 直切中棱，不靠左侧平台恢复"],
    ["安全线：逐枚光继分段校准两级弹簧", "进阶线：第一弹簧后连光继切向第二级", "高手线：四枚光继与两级弹簧一整句进出口"],
    ["安全线：脆冰只踩一下就走", "进阶线：用风代替中段落地", "高手线：风中不停顿接光继点"],
    ["安全线：站稳后吃棱镜，末段借风收住", "进阶线：过载穿过脆冰后不停顿进风", "高手线：Prism Spark 串脆冰与末段风场"],
    ["安全线：点亮回声，借风落稳中层", "进阶线：风接棱镜再接光继点", "高手线：只在保 PB 时召回"],
    ["安全线：立回声后借弹簧接光继，再逐段向上", "进阶线：弹簧光继不停顿，借风进棱镜高线", "高手线：保留召回作保险，把全套机制连到星顶"]
  ];
