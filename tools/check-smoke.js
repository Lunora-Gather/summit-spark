...
async function main() {
  ...
  try {
    ...
    ["export const TRAINING_TRANSITIONS = Object.freeze({", "export function createDrillData(", "export function drillSucceededData(", "export function activeRouteContractDataFor(", "export function advanceRouteContractData(", "export function feelFixtureModeData(", "export function recordRoomFaultData(", "export function recordDrillClearData(", "export function roomMasteryScoreData(", "export function roomReviewModeData(", "export function activeChallengeStateData(", "export function challengeProgressData(", "export function reconcileChallengeWinsData("]
