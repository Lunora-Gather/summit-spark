...
export const ROOM_TARGETS = [8.8, 10.0, 12.4, 13.0, 14.8, 17.4, 18.4, 21.5, 22.0, 24.8];
...
export const ROOM_GUIDES = [
    ...
    "先读两级弹簧的错位落点，过顶后再花冲刺。",
    "先读安全平台线，再把光继点连起来；微光藏在低位岔路。",
    "先从中棱折回左侧光继，保留冲刺再回到上层；右下微光要求多走一次折返。",
    "用四枚光继分段校准两级弹簧，微光就在组合句中段。",
    "踩上脆冰就离开，借风升高可带回峡口微光。",
    "干净进入棱镜；微光在末段脆冰上方，取到后再借风收住。",
    "先点亮回声锚点并借风落稳中层；微光在左下岔路，取到后用召回重接主线。",
    "起步先立回声，早段取到末枚微光，再把弹簧、光继、风与棱镜连到终点。"
  ];
...
export const ROOM_ROUTE_LINES = [
    ...
    ["安全线：把每个光继点当停顿", "进阶线：落地前连两次光继点", "高手线：带连锁下探微光，再穿过危险线"],
    ["安全线：在中棱折回左侧光继，再从安全台回升", "进阶线：光继后不落地，沿中棱回到上层", "高手线：Wall Spark 直切后下探右侧微光"],
    ["安全线：逐枚光继分段校准两级弹簧", "进阶线：第一弹簧后连光继切向第二级", "高手线：四枚光继、微光与两级弹簧连成一整句"],
    ["安全线：脆冰只踩一下就走", "进阶线：用风代替中段落地", "高手线：风中取微光后不停顿接光继点"],
    ["安全线：站稳后吃棱镜，末段借风收住", "进阶线：过载穿过脆冰后不停顿进风", "高手线：Prism Spark 串脆冰并带回微光"],
    ["安全线：点亮回声，借风落稳中层", "进阶线：风接棱镜再接光继点", "高手线：下探微光后用召回重接 PB 线"],
    ["安全线：立回声后借弹簧接光继，再逐段向上", "进阶线：弹簧光继不停顿，借风进棱镜高线", "高手线：早段带回末枚微光，把全套机制连到星顶"]
  ];
