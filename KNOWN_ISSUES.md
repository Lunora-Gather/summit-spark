...
- The R7→R8 pressure curve is intentionally demanding; p281 adds a longer mechanic read-in and explicit first-focus copy, but a full uninterrupted human route is still required before tuning authored geometry or targets. Do not treat a single death as evidence that the curve is unfair.
