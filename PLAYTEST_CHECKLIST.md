...
- Start a fresh full route: R1's existing non-blocking room title must pair “第一幕 · 山门” with its vow while movement remains immediately available; do not add a separate opening panel or repeat the later act-transition pause.
