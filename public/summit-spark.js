(async () => {
  ...
  const [
    ...
    import("./modules/core/format.mjs?v=20260907-p304"),
    import("./modules/core/math.mjs?v=20260907-p304"),
    import("./modules/game/room-data.mjs?v=20260907-p304"),
    import("./modules/game/world-model.mjs?v=20260907-p304"),
    import("./modules/game/effect-budget.mjs?v=20260907-p304"),
    import("./modules/game/landmark-progress.mjs?v=20260907-p304"),
    import("./modules/game/audio-cues.mjs?v=20260907-p304"),
    import("./modules/game/lumen-progress.mjs?v=20260907-p304"),
    import("./modules/systems/storage.mjs?v=20260907-p304"),
    import("./modules/systems/input.mjs?v=20260907-p304"),
    import("./modules/training/state.mjs?v=20260907-p304"),
    import("./modules/training/replay.mjs?v=20260907-p304"),
    import("./modules/ui/presentation.mjs?v=20260907-p304")
  ]);
