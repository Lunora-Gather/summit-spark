...
- From the start menu, open Settings, click a blank region to close it, then reopen Settings and click the visible Practice button region once; the drawer must switch directly to Practice instead of swallowing the pointer.
